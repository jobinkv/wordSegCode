...
public:
	...
	void loadMaskFilenames(vector<string> msk_prefix);
	vector<string> _filenames;
	
	void trainModels(string basename, string img_prefix,string msk_prefix,string model_prefix,string feat_prefix, string feature_set, int max_models, int img_width, int channel);
	string _feature_set;
